...
mixin _$ResetPasswordRequest {
 ...
 String get email;@JsonKey(name: 'otp_code') String get otpCode;@JsonKey(name: 'new_password') String get newPassword;@JsonKey(name: 'confirm_password') String get confirmPassword;
...
@override
String toString() {
  return 'ResetPasswordRequest(email: $email, otpCode: $otpCode, newPassword: $newPassword, confirmPassword: $confirmPassword)';
}
...
@useResult
$Res call({
 String email,@JsonKey(name: 'otp_code') String otpCode,@JsonKey(name: 'new_password') String newPassword,@JsonKey(name: 'confirm_password') String confirmPassword
});
...
/// Create a copy of ResetPasswordRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? otpCode = null,Object? newPassword = null,Object? confirmPassword = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String email, @JsonKey(name: 'otp_code')  String otpCode, @JsonKey(name: 'new_password')  String newPassword, @JsonKey(name: 'confirm_password')  String confirmPassword)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ResetPasswordRequest() when $default != null:
return $default(_that.email,_that.otpCode,_that.newPassword,_that.confirmPassword);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String email, @JsonKey(name: 'otp_code')  String otpCode, @JsonKey(name: 'new_password')  String newPassword, @JsonKey(name: 'confirm_password')  String confirmPassword)  $default,) {final _that = this;
switch (_that) {
case _ResetPasswordRequest():
return $default(_that.email,_that.otpCode,_that.newPassword,_that.confirmPassword);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String email, @JsonKey(name: 'otp_code')  String otpCode, @JsonKey(name: 'new_password')  String newPassword, @JsonKey(name: 'confirm_password')  String confirmPassword)?  $default,) {final _that = this;
switch (_that) {
case _ResetPasswordRequest() when $default != null:
return $default(_that.email,_that.otpCode,_that.newPassword,_that.confirmPassword);case _:
  return null;
...
class _ResetPasswordRequest implements ResetPasswordRequest {
  const _ResetPasswordRequest({required this.email, @JsonKey(name: 'otp_code') required this.otpCode, @JsonKey(name: 'new_password') required this.newPassword, @JsonKey(name: 'confirm_password') required this.confirmPassword});
...
/// Create a copy of ResetPasswordRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? email = null,Object? otpCode = null,Object? newPassword = null,Object? confirmPassword = null,}) {
